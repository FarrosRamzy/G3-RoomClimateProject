...
namespace Main_Panel_Controls
{
    public partial class MainPanel : Form
    {
        ...
        private void ActivatedButton(object btnPressed)
        {
            if (btnPressed != null)
            {
                if (currentButton != (Button)btnPressed)
                {
                    ...
                    lblTitle.Font = new System.Drawing.Font("OCR A", 26.25F, ((System.Drawing.FontStyle)(System.Drawing.FontStyle.Bold)), System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                }
            }
        }
        ...
        private void MenuClicked(Form childForm, object btnPressed)
        {
            if (activeForm != null)
            {
                activeForm.Hide();
        ...
        {
            if (childForm is SubForms.Home)
            {
                lbBackToHome.Visible = false;
                btnBackToHome.Visible = false;
            }
            else
            {
                btnBackToHome.Visible = true;
                lbBackToHome.Visible = true;
            }
